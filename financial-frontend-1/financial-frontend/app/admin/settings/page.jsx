      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="bg-slate-900 border-slate-800">
          <CardHeader>
            ...
            <CardDescription>
              Configure transaction limits and commission rules
            </CardDescription>
          </CardHeader>
        ...
        <Card className="bg-slate-900 border-slate-800">
          <CardHeader>
            ...
            <CardDescription>
              General system settings and schedule
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
            ...
            <div className="p-4 bg-slate-800 rounded-lg border border-slate-700 mt-6">
              <p className="text-sm text-slate-300 mb-3">
                <span className="font-semibold">Last Backup:</span> Today at
                02:30 AM
              </p>
